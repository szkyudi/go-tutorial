...
func (model *todoModel) FetchTodos() ([]*Todo, error) {
...
func (model *todoModel) AddTodo(r *http.Request) (sql.Result, error) {
	err := r.ParseForm()
...
func (model *todoModel) ChangeTodo(r *http.Request) (sql.Result, error) {
	err := r.ParseForm()
...
func (model *todoModel) DeleteTodo(r *http.Request) (sql.Result, error) {
	err := r.ParseForm()
